...
function FilmLibrary() {
    ...
    // This function permanently deletes one element from the library
    this.delete = (id) => {
 ...
 * @param {Array} films Array of film objects to be displayed.
 */
 ...
 * Clears the film list from the DOM.
 */
...
function filterFilms( filterId, titleText, filterFn ) {
    // Update the active filter and refresh the film list
