...
// Converts a database record into a film object
// Ensures proper formatting and handles null values for watchDate.
...
// Retrieves the list of films, optionally filtered
...
// Ensures the ID exists in the database before returning the film.
exports.getFilm = (id) => {
  return new Promise((resolve, reject) => {
